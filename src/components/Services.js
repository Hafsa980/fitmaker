...
import image from '../images/blog3.jpg'
import './Services.css';
    ...
    <section className="services-section">
      ...
      <div className="services-container">
        <div className="service-card">
          <img src={image} alt="Losing Weight" />
          <h3>Losing Weight</h3>
          <p>
        ...
        <div className="service-card">
          <img src={image} alt="Building Muscle" />
        ...
        <div className="service-card">
          <img src={image} alt="Training at Home" />
